...
import { createUser, deleteUser, getallUsers, getallUsersById, updateUser } from '../controllers/usersController';
...
router.get('/', authenticateToken, authorizePermission('GETALL_USER'), getallUsers)
router.get('/:id', authenticateToken,authorizePermission('GETID_USER'),  getallUsersById)
